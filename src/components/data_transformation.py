...
## Create Feature Engineering and Data Transformation classes
...
class DataTransformation():
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Obtaining FE steps through object")
            ...
            train_arr = np.c_(X_train, np.arr(y_train))
            
            test_arr = np.c_(X_test, np.arr(y_test))
